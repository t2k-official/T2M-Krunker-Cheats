...
<div class="dialog">${shouldShowAd ? `<big>Loading ad...</big>` : `<div class="close" onclick="this.parentNode.style.display='none';"></div>
	...
	[H] to show/hide help
	<br>
	To Use On Mobile Devices - Use The GUI Top-Right Of Your Screen To Toggle Hacks (Aimbot on right click doesn’t work on mobile devices) 
	<br>
	<br>
	By Monkeyt16 (T2MFut)
	<br>
...
function createGUI() {
	...
	contentEl.appendChild( fromHtml( `<div class="zui-item text">
		<span>Created by Monket16 (T2MFut)!</span>
	</div>` ) );
